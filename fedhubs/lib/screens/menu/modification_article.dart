...
class ModificationArticle extends StatefulWidget {
  ...
  @override
  State<ModificationArticle> createState() => _ModificationArticleState();
}

class _ModificationArticleState extends State<ModificationArticle> {
  String nomCarte = '';
  String lienSection = '';
