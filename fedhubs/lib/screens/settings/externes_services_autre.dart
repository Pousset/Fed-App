...
class ServiceAutre extends StatefulWidget {
  const ServiceAutre({Key? key}) : super(key: key);

  @override
  State<ServiceAutre> createState() => _ServiceAutreState();
}

class _ServiceAutreState extends State<ServiceAutre> {
                ...
                Padding(
                  ...
                  child: AnimatedContainer(
                    ...
                    child: TextField(
                      ...
                      style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16),
                      decoration: InputDecoration(
                        hintText: 'Indiquer le type de livraison utilisé',
                        hintStyle:
                        TextStyle(fontSize: 15, fontWeight: FontWeight.w600),
                        border: InputBorder.none,
                        prefix: SizedBox(width: 6),
