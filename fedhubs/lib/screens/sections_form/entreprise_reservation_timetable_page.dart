...
class EntrepriseReservationTimetablePage extends StatefulWidget {
  const EntrepriseReservationTimetablePage({super.key});

  @override
  State<EntrepriseReservationTimetablePage> createState() =>
      _EntrepriseReservationTimetablePageState();
}

class _EntrepriseReservationTimetablePageState
    extends State<EntrepriseReservationTimetablePage> {
  bool isChanged = false;

  late final CompanyProvider companyProvider;
  late final Future<EntrepriseTimetableModel>
      _futureEntrepriseReservationTimetable;
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  EntrepriseTimetableModel _modelEntrepriseReservationTimetable =
  ...
  void _submit() async {
    ...
    if (isValid) {
      ...
      final state = await apiUpdate.putEntrepriseReservationTimetable(
          _modelEntrepriseReservationTimetable, companyProvider.idClient!);
  ...
  void initState() {
    ...
    _futureEntrepriseReservationTimetable =
        apiRead.fetchEntrepriseReservationTimetable(companyProvider.idClient!);
    _futureEntrepriseReservationTimetable.then((value) {
      _modelEntrepriseReservationTimetable = value;
    });
    super.initState();
  }
  ...
  Widget _buildContent(Size screenSize) {
    return FutureBuilder<EntrepriseTimetableModel>(
      future: _futureEntrepriseReservationTimetable,
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildDayRow(
                        title: 'Lundi',
                        model: _modelEntrepriseReservationTimetable.mondayHours,
                      ...
                      _buildDayRow(
                        title: 'Mardi',
                        model:
                            _modelEntrepriseReservationTimetable.tuesdayHours,
                        screenWidth: screenSize.width,
                      ),
                      const SizedBox(height: 8),
                      _buildDayRow(
                        title: 'Mercredi',
                        model:
                            _modelEntrepriseReservationTimetable.wednesdayHours,
                        screenWidth: screenSize.width,
                      ),
                      const SizedBox(height: 8),
                      _buildDayRow(
                        title: 'Jeudi',
                        model:
                            _modelEntrepriseReservationTimetable.thursdayHours,
                        screenWidth: screenSize.width,
                      ),
                      const SizedBox(height: 8),
                      _buildDayRow(
                        title: 'Vendredi',
                        model: _modelEntrepriseReservationTimetable.fridayHours,
                        screenWidth: screenSize.width,
                      ),
                      const SizedBox(height: 8),
                      _buildDayRow(
                        title: 'Samedi',
                        model:
                            _modelEntrepriseReservationTimetable.saturdayHours,
                        screenWidth: screenSize.width,
                      ),
                      const SizedBox(height: 8),
                      _buildDayRow(
                        title: 'Dimanche',
                        model: _modelEntrepriseReservationTimetable.sundayHours,
                        screenWidth: screenSize.width,
                      ),
                    ],
                  ),
